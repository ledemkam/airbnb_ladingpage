...
const Card = ({ city, country, dates, price_per_night, rating, owner, images}:CardProps) => {
  return (
    ...
    <div className="px-1 py-4">
      ...
      <p className="text-gray-700 text-base">vorgeschlagen von: {owner}</p>
      <p className="text-gray-700 text-base">{dates}</p>
      <p className="text-gray-700 text-base"><b>{price_per_night}€</b> <span>pro nacht</span></p>
    </div>
  </div>
  )
}
